...
const MobKind kVillagerKind{
    "minecraft:villager", MobCategory::Misc,
    walk_blocks_per_tick(kVillagerSpeedAttribute * kWalkModifier),
    /*opens_doors=*/true, /*avoids_sun=*/false, /*hostile=*/false,
    /*panics=*/false, /*breeds=*/false,
};
...
void install_villager_goals(GoalSelector& selector, const MobKind& kind, i32 look_type) {
    const f64 walk  = kind.walk_speed;
