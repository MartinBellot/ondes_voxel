...
function(ov_check_cxx23_support)
    ...
    message(FATAL_ERROR
        ...
        "  GCC 13 or newer\n"
        "  Clang 19 or newer with libstdc++\n"
        "  Apple Clang 15 or newer\n"
        "  MSVC 19.34 or newer\n"
        "\n"
        "Clang 18 and older cannot use libstdc++'s <expected>, whatever libstdc++\n"
        "version is installed. The header is guarded by __cpp_concepts >= 202002L,\n"
        "and clang 18 defines that macro as 201907L — the original C++20 value,\n"
        "before CWG2560 — so the header compiles to nothing. Clang 19 bumped it.\n"
        "\n"
        "    wget -qO- https://apt.llvm.org/llvm.sh | sudo bash -s -- 19\n"
        "    CXX=clang++-19 cmake --preset linux-debug\n"
        "\n"
        "Two things that look like the fix and are not:\n"
        "  Installing a newer g++ changes nothing — the guard is on the\n"
        "  compiler's macro, not on the library version.\n"
        "  -stdlib=libc++ mixes two standard library ABIs, because vcpkg builds\n"
        "  the dependencies with the default toolchain, and the link then fails\n"
        "  on std::string symbols — a more confusing failure than this one.\n")
endfunction()
