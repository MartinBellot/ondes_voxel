...
| [`chargement-terrain.md`](provenance/chargement-terrain.md) | Le terrain qui ne suivait pas le joueur : un profil (75 % dans les surfaces de l'aquifère), des optimisations prouvées au bit près par un condensé, l'ordonnancement au plus proche, l'écran « Loading terrain » à sa place, la sauvegarde hors du tick — mesuré sur un banc de streaming. Aucun code tiers ; les règles d'apparition de l'écran de chargement sont dites, avec leur source, au § 8 du fichier |
...
| [`mobs-5.md`](provenance/mobs-5.md) | L'enderman : le cône du regard (k ∈ [0,022 ; 0,030]), la citrouille, l'eau, la pluie, les téléports ±32, porter et poser étalonnés sur le vrai serveur |
...
| [`cerveaux.md`](provenance/cerveaux.md) | Le système de cerveaux (mémoires, capteurs, activités) et la vie des villageois : 90/90 prix sous réputation et Héros du village, oubli et transmission des ragots, horaire, reproduction, fermiers, golems invoqués (7/7 cellules), type par biome (53/53), tables du marchand ambulant — et un bibliothécaire qui perdait son métier avant qu'on puisse lui parler |
